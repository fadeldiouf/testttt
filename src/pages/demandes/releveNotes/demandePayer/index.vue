<template>
  <section>
<p class="text-h6">Relevés de notes en cours de traitement</p>
...
const { encoursPayer, destroym,moveToAtraiter } = releveStore;
...
const confirmAction = async () => {
  try {
    ...
    router.push({ name: 'demandes-releve-notes-demande-ensignature'} )
