<template>
  <section>
<p class="text-h6">Relevés de notes en attente de signature</p>
...
const { atraiterPayer, destroym,moveToDisponible } = releveStore;
...
const confirmAction = async () => {
  try {
    ...
    router.push({ name: 'demandes-releve-notes-demande-disponible'} )
