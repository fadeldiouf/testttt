<template>
  <section>
<p class="text-h6">Duplicatas en attente de signature</p>
...
const { atraiterPayer, destroym,moveToDisponible } = duplicataStore;
...
const confirmAction = async () => {
  try {
    ...
    router.push({ name: 'demandes-duplicata-demande-disponible'} )
