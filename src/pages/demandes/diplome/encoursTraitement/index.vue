<template>
  <section>
<p class="text-h6">Diplômes en cours de traitement</p>
...
const { encours, destroym,moveToAtraiter } = diplomeStore;
...
const confirmAction = async () => {
  try {
    ...
    router.push({ name: 'demandes-diplome-demande-ensignature'} )
