<template>
  <section>
<p class="text-h6">Attestations en attente de signature</p>
...
const { atraiterPayer, destroym,moveToDisponible } = attestationStore;
...
const confirmAction = async () => {
  try {
    ...
    router.push({ name: 'demandes-attestation-demande-disponible'} )
