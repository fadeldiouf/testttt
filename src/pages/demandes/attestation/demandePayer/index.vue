<template>
  <section>
<p class="text-h6">Attestations en cours de traitement</p>
...
import { useAttestationStore } from '@/views/demandes/attestation/store'
import { toast } from 'vue3-toastify';

const attestationStore = useAttestationStore()
const {loading,columns,dataListeBachelier,etatCouleurs } = storeToRefs(attestationStore);
const { encoursPayer, destroym,moveToAtraiter } = attestationStore;
...
const confirmAction = async () => {
  try {
    ...
    router.push({ name: 'demandes-attestation-demande-ensignature'} )
